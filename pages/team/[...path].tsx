...
import MatchTableHeadRow from "../../app/components/match/MatchTableHeadRow";
import MatchRowWithoutLink from "../../app/components/match/MatchRowWithoutLink";
import MatchRow from "../../app/components/match/MatchRow";
...
const Team = ({team, matches, content, players, tournaments, tweets, paths, videos,nextMatch}) => {
    return <>
        ...
        <div className="team">
            ...
            <Row>
                <Col md={8}>
                    <Card className="mb-3">
                        <div className="mb-2"><strong>Last Matches</strong></div>
                        {
                            matches.map((league, i) => {
                                return <Matches removeLinking key={i} league={league}/>
                            })
                        }
                    </Card>
                    <Row className="mb-3">
                ...
                <Col md={4}>
                    <Card className="mb-3">
                        ...
                        <div className="mb-2"><strong>Upcoming Match</strong></div>
                        <div>
                            <Table  className="matchTable" head={<MatchTableHeadRow/>} RowComponent={ MatchRow}
                                    bodyData={ nextMatch ? [nextMatch] : []}/>
                        </div>
                    </Card>
...
const mapStateToProps = state => ({
    ...
    nextMatch: state.team.nextMatch,
